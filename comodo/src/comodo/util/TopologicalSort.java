 ...
 * 
 * $Id: TopologicalSort.java 480 2011-10-10 08:41:55Z landolfa $
 * 
 */
...
public class TopologicalSort {
	 ...
	 * @param elementList
	 */
	public static final List<Classifier> getTopicSorted(List<Classifier> elementList)
	{
		Vector<NodeElement> toSort = new Vector<NodeElement>();
		...
		for(Classifier eElement : elementList)
		{
			...
			NodeElement node = new NodeElement(nodeName, stringVectorToArray(edge));
			toSort.add(node);
		}
	 ...
	 * @param elementList
	 */
	public static final boolean hasCircularDependencies(List<Classifier> elementList)
	{
		Vector<NodeElement> toSort = new Vector<NodeElement>();
	 ...
	 * @return ENodeElement[]
	 */
	public static final NodeElement[] eElementVectorToArray(Vector<NodeElement> vectoreElement)
	{
		NodeElement[] elementString = new NodeElement[vectoreElement.size()];
	...
	{
		for(Classifier eElement : elementList)
			if(eElement.getName().equals(typeName))
				return true;
		return false;
	}
	...
	public static final String[] topologicalSort(NodeElement[] eNode) throws Exception {
		/*

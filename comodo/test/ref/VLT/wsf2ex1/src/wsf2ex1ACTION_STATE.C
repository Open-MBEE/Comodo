...
#include "wsf2ex1.h"
wsf2ex1WSF_RCSID("@(#) $Id: wsf2ex1ACTION_STATE.C 593 2012-04-22 12:12:12Z landolfa $")
 ...
 */
wsf2ex1ACTION_STATE::wsf2ex1ACTION_STATE(wsf2ex1ACTION_MGR& actionMgr,
				       wsf2libCONTROL& control,
				       wsf2ex1CONFIG& config,
				       wsf2ex1DATA& data) :
    wsf2libACTION_STATE(wsf2ex1ACTION_STR_STATE, actionMgr, control),
 ...
 * Destructor
 */
wsf2ex1ACTION_STATE::~wsf2ex1ACTION_STATE()
{
    wsf2libLOG_TRACE();
}

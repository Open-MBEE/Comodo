...
#include "wsf2ex1.h"
wsf2ex1WSF_RCSID("@(#) $Id: wsf2ex1ACTION_STOP.C 593 2012-04-22 12:12:12Z landolfa $")
 ...
 */
wsf2ex1ACTION_STOP::wsf2ex1ACTION_STOP(wsf2ex1ACTION_MGR& actionMgr,
				       wsf2libCONTROL& control,
				       wsf2ex1CONFIG& config,
				       wsf2ex1DATA& data) :
    wsf2libACTION_STOP(wsf2ex1ACTION_STR_STOP, actionMgr, control),
 ...
 * Destructor
 */
wsf2ex1ACTION_STOP::~wsf2ex1ACTION_STOP()
{
    wsf2libLOG_TRACE();
}

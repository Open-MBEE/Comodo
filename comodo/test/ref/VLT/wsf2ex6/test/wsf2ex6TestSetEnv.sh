...
#************************************************************************
#   NAME
#   wsf2ex6SetEnv - Set environment variables for wsf2ex6 module
#
#   SYNOPSIS
#   wsf2ex6SetEnv [INS_ROOT]
#
#   DESCRIPTION
...
echo "Setting environment variables for wsf2ex6 module"
echo "To be effective, run the script as: source wsf2ex6SetEnv [INS_ROOT]"
if [ $# -lt 1 ]; then

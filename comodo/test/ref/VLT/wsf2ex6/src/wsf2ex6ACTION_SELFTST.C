...
#include "wsf2ex6.h"
wsf2ex6WSF_RCSID("@(#) $Id: wsf2ex6ACTION_SELFTST.C 593 2012-04-22 12:12:12Z landolfa $")
 ...
 */
wsf2ex6ACTION_SELFTST::wsf2ex6ACTION_SELFTST(wsf2ex6ACTION_MGR& actionMgr,
				       wsf2libCONTROL& control,
				       wsf2ex6CONFIG& config,
				       wsf2ex6DATA& data) :
    wsf2libACTION_SELFTST(wsf2ex6ACTION_STR_SELFTST, actionMgr, control),
 ...
 * Destructor
 */
wsf2ex6ACTION_SELFTST::~wsf2ex6ACTION_SELFTST()
{
    wsf2libLOG_TRACE();
}

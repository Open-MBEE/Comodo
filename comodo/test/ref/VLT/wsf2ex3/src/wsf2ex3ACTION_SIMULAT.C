...
#include "wsf2ex3.h"
wsf2ex3WSF_RCSID("@(#) $Id: wsf2ex3ACTION_SIMULAT.C 593 2012-04-22 12:12:12Z landolfa $")
 ...
 */
wsf2ex3ACTION_SIMULAT::wsf2ex3ACTION_SIMULAT(wsf2ex3ACTION_MGR& actionMgr,
				       wsf2libCONTROL& control,
				       wsf2ex3CONFIG& config,
				       wsf2ex3DATA& data) :
    wsf2libACTION_SIMULAT(wsf2ex3ACTION_STR_SIMULAT, actionMgr, control),
 ...
 * Destructor
 */
wsf2ex3ACTION_SIMULAT::~wsf2ex3ACTION_SIMULAT()
{
    wsf2libLOG_TRACE();
}

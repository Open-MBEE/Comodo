...
#include "wsf2ex3.h"
wsf2ex3WSF_RCSID("@(#) $Id: wsf2ex3ACTION_OFF.C 593 2012-04-22 12:12:12Z landolfa $")
 ...
 */
wsf2ex3ACTION_OFF::wsf2ex3ACTION_OFF(wsf2ex3ACTION_MGR& actionMgr,
				       wsf2libCONTROL& control,
				       wsf2ex3CONFIG& config,
				       wsf2ex3DATA& data) :
    wsf2libACTION_OFF(wsf2ex3ACTION_STR_OFF, actionMgr, control),
 ...
 * Destructor
 */
wsf2ex3ACTION_OFF::~wsf2ex3ACTION_OFF()
{
    wsf2libLOG_TRACE();
}

...
#************************************************************************
#   NAME
#   wsf2ex3SetEnv - Set environment variables for wsf2ex3 module
#
#   SYNOPSIS
#   wsf2ex3SetEnv [INS_ROOT]
#
#   DESCRIPTION
...
echo "Setting environment variables for wsf2ex3 module"
echo "To be effective, run the script as: source wsf2ex3SetEnv [INS_ROOT]"
if [ $# -lt 1 ]; then

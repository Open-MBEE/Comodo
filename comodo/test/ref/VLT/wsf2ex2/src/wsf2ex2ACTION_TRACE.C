...
#include "wsf2ex2.h"
wsf2ex2WSF_RCSID("@(#) $Id: wsf2ex2ACTION_TRACE.C 593 2012-04-22 12:12:12Z landolfa $")
 ...
 */
wsf2ex2ACTION_TRACE::wsf2ex2ACTION_TRACE(wsf2ex2ACTION_MGR& actionMgr,
				       wsf2libCONTROL& control,
				       wsf2ex2CONFIG& config,
				       wsf2ex2DATA& data) :
    wsf2libACTION_TRACE(wsf2ex2ACTION_STR_TRACE, actionMgr, control),
 ...
 * Destructor
 */
wsf2ex2ACTION_TRACE::~wsf2ex2ACTION_TRACE()
{
    wsf2libLOG_TRACE();
}

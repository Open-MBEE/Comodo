...
#include "wsf2ex2.h"
wsf2ex2WSF_RCSID("@(#) $Id: wsf2ex2ACTION_EXIT.C 593 2012-04-22 12:12:12Z landolfa $")
 ...
 */
wsf2ex2ACTION_EXIT::wsf2ex2ACTION_EXIT(wsf2ex2ACTION_MGR& actionMgr,
				       wsf2libCONTROL& control,
				       wsf2ex2CONFIG& config,
				       wsf2ex2DATA& data) :
    wsf2libACTION_EXIT(wsf2ex2ACTION_STR_EXIT, actionMgr, control),
 ...
 * Destructor
 */
wsf2ex2ACTION_EXIT::~wsf2ex2ACTION_EXIT()
{
    wsf2libLOG_TRACE();
}

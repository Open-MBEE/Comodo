...
#************************************************************************
#   NAME
#   wsf2ex2SetEnv - Set environment variables for wsf2ex2 module
#
#   SYNOPSIS
#   wsf2ex2SetEnv [INS_ROOT]
#
#   DESCRIPTION
...
echo "Setting environment variables for wsf2ex2 module"
echo "To be effective, run the script as: source wsf2ex2SetEnv [INS_ROOT]"
if [ $# -lt 1 ]; then

...
#************************************************************************
#   NAME
#   wsf2ex4SetEnv - Set environment variables for wsf2ex4 module
#
#   SYNOPSIS
#   wsf2ex4SetEnv [INS_ROOT]
#
#   DESCRIPTION
...
echo "Setting environment variables for wsf2ex4 module"
echo "To be effective, run the script as: source wsf2ex4SetEnv [INS_ROOT]"
if [ $# -lt 1 ]; then

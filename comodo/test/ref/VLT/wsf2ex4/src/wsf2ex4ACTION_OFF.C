...
#include "wsf2ex4.h"
wsf2ex4WSF_RCSID("@(#) $Id: wsf2ex4ACTION_OFF.C 593 2012-04-22 12:12:12Z landolfa $")
 ...
 */
wsf2ex4ACTION_OFF::wsf2ex4ACTION_OFF(wsf2ex4ACTION_MGR& actionMgr,
				       wsf2libCONTROL& control,
				       wsf2ex4CONFIG& config,
				       wsf2ex4DATA& data) :
    wsf2libACTION_OFF(wsf2ex4ACTION_STR_OFF, actionMgr, control),
 ...
 * Destructor
 */
wsf2ex4ACTION_OFF::~wsf2ex4ACTION_OFF()
{
    wsf2libLOG_TRACE();
}

#ifndef wsf2ex4ACTION_READ_H
#define wsf2ex4ACTION_READ_H
/*******************************************************************************
*    E.S.O. - VLT project
*
*    "@(#) $Id$"
 ...
 * READ action class.    
 */
class wsf2ex4ACTION_READ : public wsf2libACTION
{
  public:
    wsf2ex4ACTION_READ(wsf2ex4ACTION_MGR& actionMgr,
		       wsf2libCONTROL& control, 
		       wsf2ex4CONFIG& config, 
		       wsf2ex4DATA& data);
    virtual ~wsf2ex4ACTION_READ();
  ...
  private:
    ...
    wsf2ex4ACTION_READ(const wsf2ex4ACTION_READ&);
    wsf2ex4ACTION_READ& operator= (const wsf2ex4ACTION_READ&);
};

	

#endif // !wsf2ex4ACTION_READ_H

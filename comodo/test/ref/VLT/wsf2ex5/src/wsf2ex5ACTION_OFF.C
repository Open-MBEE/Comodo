...
#include "wsf2ex5.h"
wsf2ex5WSF_RCSID("@(#) $Id: wsf2ex5ACTION_OFF.C 593 2012-04-22 12:12:12Z landolfa $")
 ...
 */
wsf2ex5ACTION_OFF::wsf2ex5ACTION_OFF(wsf2ex5ACTION_MGR& actionMgr,
				       wsf2libCONTROL& control,
				       wsf2ex5CONFIG& config,
				       wsf2ex5DATA& data) :
    wsf2libACTION_OFF(wsf2ex5ACTION_STR_OFF, actionMgr, control),
 ...
 * Destructor
 */
wsf2ex5ACTION_OFF::~wsf2ex5ACTION_OFF()
{
    wsf2libLOG_TRACE();
}

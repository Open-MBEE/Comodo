...
#************************************************************************
#   NAME
#   wsf2ex5SetEnv - Set environment variables for wsf2ex5 module
#
#   SYNOPSIS
#   wsf2ex5SetEnv [INS_ROOT]
#
#   DESCRIPTION
...
echo "Setting environment variables for wsf2ex5 module"
echo "To be effective, run the script as: source wsf2ex5SetEnv [INS_ROOT]"
if [ $# -lt 1 ]; then

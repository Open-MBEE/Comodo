...
import alma.MARS.OCInterfacePOATie;
 ...
 * @version $Id$
 */
public class OCJavaImpHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public OCJavaImpHelper(Logger containerLogger) {
	...
	protected Class _getPOATieClass() {
		return OCInterfacePOATie.class;
	}
	...
	protected Class _getOperationsInterface() {
		return OCInterfaceOperations.class;
	}

 ...
 * @version $Id$
 */
public abstract class TRDJavaImpAbstract
		implements
			ComponentLifecycle,
			TRDInterfaceOperations {
	 ...
	 * @return command
	 */
	public abstract command getRAB(int type);
	 ...
	 * @return int
	 */
	public abstract int createReport(report rep);

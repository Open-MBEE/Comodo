...
import alma.MARS.FDInterfacePOATie;
import alma.MARS.FDInterfaceOperations;

/**
 * @see alma.MARSCommon
 * @see alma.MARS.FDInterface
 * @see alma.MARS.FDInterfaceOperations
 * @see alma.acs.component.ComponentLifecycle
 * @author ACS Component Code Generator
 * @version $Id$
 */
public class FDJavaImpHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public FDJavaImpHelper(Logger containerLogger) {
	...
	protected Class _getPOATieClass() {
		return FDInterfacePOATie.class;
	}
	...
	protected Class _getOperationsInterface() {
		return FDInterfaceOperations.class;
	}

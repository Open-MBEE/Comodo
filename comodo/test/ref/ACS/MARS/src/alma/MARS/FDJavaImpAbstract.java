 ...
 * @version $Id$
 */
public abstract class FDJavaImpAbstract
		implements
			ComponentLifecycle,
			FDInterfaceOperations {
	 ...
	 */
	public abstract sensor_status sensorStatus(int id);
	 ...
	 * @return void
	 */
	public abstract void resetSensor(int id);

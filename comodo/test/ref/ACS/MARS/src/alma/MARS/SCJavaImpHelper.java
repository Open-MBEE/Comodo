...
import alma.MARS.SCInterfacePOATie;
import alma.MARS.SCInterfaceOperations;

/**
 * @see alma.MARSCommon
 * @see alma.MARS.SCInterface
 * @see alma.MARS.SCInterfaceOperations
 * @see alma.acs.component.ComponentLifecycle
 * @author ACS Component Code Generator
 * @version $Id$
 */
public class SCJavaImpHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public SCJavaImpHelper(Logger containerLogger) {
	...
	protected Class _getPOATieClass() {
		return SCInterfacePOATie.class;
	}
	...
	protected Class _getOperationsInterface() {
		return SCInterfaceOperations.class;
	}

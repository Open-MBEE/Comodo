...
import alma.MARS.TSInterfacePOATie;
 ...
 * @version $Id$
 */
public class TSJavaImpHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public TSJavaImpHelper(Logger containerLogger) {
	...
	protected Class _getPOATieClass() {
		return TSInterfacePOATie.class;
	}
	...
	protected Class _getOperationsInterface() {
		return TSInterfaceOperations.class;
	}

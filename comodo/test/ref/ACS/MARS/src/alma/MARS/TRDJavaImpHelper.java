...
import alma.MARS.TRDInterfacePOATie;
import alma.MARS.TRDInterfaceOperations;

/**
 * @see alma.MARSCommon
 * @see alma.MARS.TRDInterface
 * @see alma.MARS.TRDInterfaceOperations
 * @see alma.acs.component.ComponentLifecycle
 * @author ACS Component Code Generator
 * @version $Id$
 */
public class TRDJavaImpHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public TRDJavaImpHelper(Logger containerLogger) {
	...
	protected Class _getPOATieClass() {
		return TRDInterfacePOATie.class;
	}
	...
	protected Class _getOperationsInterface() {
		return TRDInterfaceOperations.class;
	}

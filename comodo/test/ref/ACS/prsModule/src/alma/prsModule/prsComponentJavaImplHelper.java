...
import alma.prsModule.PrsInterfacePOATie;
 ...
 * @version $Id$
 */
public class prsComponentJavaImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public prsComponentJavaImplHelper(Logger containerLogger) {
	...
	protected ComponentLifecycle _createComponentImpl() {
		return new prsComponentJavaImpl();
	}
	...
	protected Class _getPOATieClass() {
		return PrsInterfacePOATie.class;
	}
	...
	protected Class _getOperationsInterface() {
		return PrsInterfaceOperations.class;
	}

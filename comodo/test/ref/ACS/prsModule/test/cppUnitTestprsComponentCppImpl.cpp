...
class prsComponentCppImplTest: public CppUnit::TestFixture 
{
	private:
...
int main(int argc, char *argv[]) 
{
	...
	// testPark
	CppUnit::TestCaller<prsComponentCppImplTest> ParkTest ("testInstanceprsComponentCppImpl", &prsComponentCppImplTest::testPark);

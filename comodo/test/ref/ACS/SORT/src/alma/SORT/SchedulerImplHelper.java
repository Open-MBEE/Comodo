...
import alma.SORT.SchedulerPOATie;
import alma.SORT.SchedulerOperations;

/**
 * @see alma.SORTCommon
 * @see alma.SORT.Scheduler
 * @see alma.SORT.SchedulerOperations
 * @see alma.acs.component.ComponentLifecycle
 * @author ACS Component Code Generator
 * @version $Id$
 */
public class SchedulerImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public SchedulerImplHelper(Logger containerLogger) {

...
import alma.SORT.CommonOperationsPOATie;
import alma.SORT.CommonOperationsOperations;
import alma.SORT.InstrumentPOATie;
 ...
 * @version $Id$
 */
public class InstrumentImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public InstrumentImplHelper(Logger containerLogger) {

...
import alma.SORT.Instrument;
import alma.SORT.InstrumentOperations;

/**
 * @see alma.SORTCommon
 * @see alma.SORT.CommonOperations
 * @see alma.SORT.CommonOperationsOperations
 * @see alma.SORT.Instrument
 * @see alma.SORT.InstrumentOperations
 * @see alma.acs.component.ComponentLifecycle
 * @author ACS Component Code Generator
 * @version $Id$
 */
public abstract class InstrumentImplAbstract
		implements
			ComponentLifecycle,
	...
	/////////////////////////////////////////////////////////////
	/**	 * Retrieve image from the Instrument. Raises an exception if the camera
	
	 * @param exposureTime 
	 * @return ImageType
	 */
	public abstract ImageType takeImage(int exposureTime);

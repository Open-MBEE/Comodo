 ...
 * @version $Id$
 */
public class NexstarImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public NexstarImplHelper(Logger containerLogger) {

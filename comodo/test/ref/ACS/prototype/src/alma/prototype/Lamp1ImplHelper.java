...
import alma.prototype.Lamp1POATie;
import alma.prototype.Lamp1Operations;
 ...
 * @see alma.prototype.Lamp1
 * @see alma.prototype.Lamp1Operations
 * @see alma.acs.component.ComponentLifecycle
 * @author ACS Component Code Generator
 * @version $Id$
 */
public class Lamp1ImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public Lamp1ImplHelper(Logger containerLogger) {

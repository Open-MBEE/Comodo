 ...
 * @version $Id$
 */
public class SubsystemImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public SubsystemImplHelper(Logger containerLogger) {
	...
	protected Class _getOperationsInterface() {
		return SubsystemOperations.class;
	}

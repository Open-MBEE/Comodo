...
import alma.prototype.ICSPOATie;
 ...
 * @version $Id$
 */
public class ICSImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public ICSImplHelper(Logger containerLogger) {

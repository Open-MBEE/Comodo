...
import alma.prototype.CCDImagPOATie;
import alma.prototype.CCDImagOperations;

/**
 * @see alma.prototypeCommon
 * @see alma.prototype.Device
 * @see alma.prototype.DeviceOperations
 * @see alma.prototype.CCDImag
 * @see alma.prototype.CCDImagOperations
 * @see alma.acs.component.ComponentLifecycle
 * @author ACS Component Code Generator
 * @version $Id$
 */
public class CCDImagImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public CCDImagImplHelper(Logger containerLogger) {
	...
	protected Class _getOperationsInterface() {
		return CCDImagOperations.class;
	}

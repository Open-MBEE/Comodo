...
import alma.prototype.CCDSpectroPOATie;
 ...
 * @version $Id$
 */
public class CCDSpectroImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public CCDSpectroImplHelper(Logger containerLogger) {
	...
	protected Class _getOperationsInterface() {
		return CCDSpectroOperations.class;
	}

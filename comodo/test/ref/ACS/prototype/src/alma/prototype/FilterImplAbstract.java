 ...
 * @version $Id$
 */
public abstract class FilterImplAbstract extends CharacteristicComponentImpl
		implements
			ComponentLifecycle,
			MotorOperations,
			DeviceOperations,
	...
	public void initialize(ContainerServices containerServices)
		...
		try {
			...
			throw new ComponentLifecycleException(
					"Failed to create properties of Filter", throwable);
		}

...
import alma.prototype.OSPOATie;
 ...
 * @version $Id$
 */
public class OSImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public OSImplHelper(Logger containerLogger) {

...
class SubsystemImplTest: public CppUnit::TestFixture 
{
	private:
...
int main(int argc, char *argv[]) 
{
	...
	// testSendCommand
	CppUnit::TestCaller<SubsystemImplTest> SendCommandTest ("testInstanceSubsystemImpl", &SubsystemImplTest::testSendCommand);

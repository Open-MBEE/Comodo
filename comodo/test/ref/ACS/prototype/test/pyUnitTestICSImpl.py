...
class ICSImplTestPy(unittest.TestCase):
	...
	def setUp(self):
		...
		self.componentName = "testInstanceICSImpl"
		self.simpleClient.getLogger().logInfo("pyUnitTestICSImpl.ICSImplTestPy.setUp()...")
	...
	def tearDown(self):
		self.simpleClient.getLogger().logInfo("pyUnitTestICSImpl.ICSImplTestPy.tearDown()...")
	...
	def testSendCommand(self):
		self.simpleClient.getLogger().logInfo("pyUnitTestICSImpl.ICSImplTestPy.testSendCommand()...")
		response = None
...
if __name__ == "__main__":
	unittest.main()
	print "End of ICSImplTestPy test __oOo__"

...
class OSImplTestPy(unittest.TestCase):
	...
	def setUp(self):
		...
		self.componentName = "testInstanceOSImpl"
		self.simpleClient.getLogger().logInfo("pyUnitTestOSImpl.OSImplTestPy.setUp()...")
	...
	def tearDown(self):
		self.simpleClient.getLogger().logInfo("pyUnitTestOSImpl.OSImplTestPy.tearDown()...")
	...
	def testSendCommand(self):
		self.simpleClient.getLogger().logInfo("pyUnitTestOSImpl.OSImplTestPy.testSendCommand()...")
		response = None
		commandName = 'emptyString'
		parameterList = 'emptyString'
		response = self.component.sendCommand(commandName, parameterList)
...
if __name__ == "__main__":
	unittest.main()
	print "End of OSImplTestPy test __oOo__"

...
import alma.EventSubscriber.EventSubscriberIFPOATie;
 ...
 * @version $Id$
 */
public class EventSubscriberImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public EventSubscriberImplHelper(Logger containerLogger) {
	...
	protected Class _getPOATieClass() {
		return EventSubscriberIFPOATie.class;
	}
	...
	protected Class _getOperationsInterface() {
		return EventSubscriberIFOperations.class;
	}

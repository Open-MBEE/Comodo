...
import alma.MasterComponent.MasterComponentIFReadOnlyPOATie;
import alma.MasterComponent.MasterComponentIFReadOnlyOperations;
import alma.MasterComponent.MasterComponentIFPOATie;
 ...
 * @version $Id$
 */
public class MasterComponentImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public MasterComponentImplHelper(Logger containerLogger) {
	...
	protected Class _getPOATieClass() {
		return MasterComponentIFPOATie.class;
	}
	...
	protected Class _getOperationsInterface() {
		return MasterComponentIFOperations.class;
	}

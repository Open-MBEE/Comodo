...
public class SMActivityinitSubsysPass2 extends SMActivity {

	private volatile boolean mIsRunning;

	public SMActivityinitSubsysPass2(String parentStateId,
	...
	public void run() {
		...
		//JUST FOR TESTING
		System.out.println("Starting with initSubsysPass2");
		mIsRunning = true;
		try {
			while (mIsRunning) {
			...
			System.out
					.println("Done with initSubsysPass2... Sending message \"initSubsysPass2.done\"");
			mParentSCInstance.getExecutor().triggerEvent(
					new TriggerEvent("initSubsysPass2.done",

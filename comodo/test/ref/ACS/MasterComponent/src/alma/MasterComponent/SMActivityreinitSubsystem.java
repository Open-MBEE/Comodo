...
public class SMActivityreinitSubsystem extends SMActivity {

	private volatile boolean mIsRunning;

	public SMActivityreinitSubsystem(String parentStateId,
	...
	public void run() {
		...
		//JUST FOR TESTING
		System.out.println("Starting with reinitSubsystem");
		mIsRunning = true;
		try {
			while (mIsRunning) {
			...
			System.out
					.println("Done with reinitSubsystem... Sending message \"reinitSubsystem.done\"");
			mParentSCInstance.getExecutor().triggerEvent(
					new TriggerEvent("reinitSubsystem.done",

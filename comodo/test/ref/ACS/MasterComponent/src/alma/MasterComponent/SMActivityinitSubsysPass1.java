...
public class SMActivityinitSubsysPass1 extends SMActivity {

	private volatile boolean mIsRunning;

	public SMActivityinitSubsysPass1(String parentStateId,
	...
	public void run() {
		...
		//JUST FOR TESTING
		System.out.println("Starting with initSubsysPass1");
		mIsRunning = true;
		try {
			while (mIsRunning) {
			...
			System.out
					.println("Done with initSubsysPass1... Sending message \"initSubsysPass1.done\"");
			mParentSCInstance.getExecutor().triggerEvent(
					new TriggerEvent("initSubsysPass1.done",

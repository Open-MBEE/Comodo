...
public class SMActivityshutdownSubsysPass2 extends SMActivity {

	private volatile boolean mIsRunning;

	public SMActivityshutdownSubsysPass2(String parentStateId,
	...
	public void run() {
		...
		//JUST FOR TESTING
		System.out.println("Starting with shutdownSubsysPass2");
		mIsRunning = true;
		try {
			while (mIsRunning) {
			...
			System.out
					.println("Done with shutdownSubsysPass2... Sending message \"shutdownSubsysPass2.done\"");
			mParentSCInstance.getExecutor().triggerEvent(
					new TriggerEvent("shutdownSubsysPass2.done",

...
public class SMActivityshutdownSubsysPass1 extends SMActivity {

	private volatile boolean mIsRunning;

	public SMActivityshutdownSubsysPass1(String parentStateId,
	...
	public void run() {
		...
		//JUST FOR TESTING
		System.out.println("Starting with shutdownSubsysPass1");
		mIsRunning = true;
		try {
			while (mIsRunning) {
			...
			System.out
					.println("Done with shutdownSubsysPass1... Sending message \"shutdownSubsysPass1.done\"");
			mParentSCInstance.getExecutor().triggerEvent(
					new TriggerEvent("shutdownSubsysPass1.done",

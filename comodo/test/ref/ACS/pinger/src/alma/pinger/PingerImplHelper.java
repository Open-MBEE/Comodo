...
import alma.pinger.PingerIFPOATie;
 ...
 * @version $Id$
 */
public class PingerImplHelper extends ComponentHelper {

	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public PingerImplHelper(Logger containerLogger) {
	...
	protected Class _getOperationsInterface() {
		return PingerIFOperations.class;
	}

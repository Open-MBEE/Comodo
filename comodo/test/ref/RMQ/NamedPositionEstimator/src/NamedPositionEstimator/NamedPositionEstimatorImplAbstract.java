...
import NamedPositionEstimator.SMJavaInvoker;
 ...
 * @version $Id$
 */
public abstract class NamedPositionEstimatorImplAbstract {
	private final static String CMD_QUEUE_NAME = "NAMEDPOSITIONESTIMATORIMPL_CMD"; // for point to point commands
	...
	public boolean smLoadDefinition(final String fileName) {
		...
		if (fileName.isEmpty()) {
			modelLoc = "NamedPositionEstimator.xml";
		}
		try {

...
import FilterWheelHWAdapter.GetActPos;
...
public abstract class SMActivity implements Runnable {
	...
	protected GetActPos mGetActPos = new GetActPos(); // subscribing
	protected EncoderHealthSV mEncoderHealthSV = new EncoderHealthSV(); // subscribing

	protected NamedPositionSV mNamedPositionSV = new NamedPositionSV(); // publishing
	...
	public Message nextMessage(long timeout)
		...
		if (delivery != null) {
			...
			} else if (routingKey.matches("GetActPos")) {
				mGetActPos.setPayload(payload);

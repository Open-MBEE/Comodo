...
import NamedPositionEstimator.NamedPositionEstimatorImplAbstract;
 ...
 * @see NamedPositionEstimator.NamedPositionEstimatorImplAbstract
 * @author COMODO
 * @version $Id$
 */
public class NamedPositionEstimatorImpl
		extends
			NamedPositionEstimatorImplAbstract {
	public void run() throws java.io.IOException,
		...
		while (isRunning()) {
			try {
				...
				getLogger().debug(
						" [NamedPositionEstimatorImpl] Received '" + message
								+ "'");

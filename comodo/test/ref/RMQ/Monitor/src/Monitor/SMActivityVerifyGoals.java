...
import Monitor.SMActivity;
import RMQCommons.Message;

public class SMActivityVerifyGoals extends SMActivity {

	public SMActivityVerifyGoals(String name, String parentStateId,
		...
		while (isRunning()) {
			try {
				...
				if (msg != null) {
					...
					if (msg.getName().matches(mEncoderHealthSV.getName())) {
						// ToBeImplemented
					}

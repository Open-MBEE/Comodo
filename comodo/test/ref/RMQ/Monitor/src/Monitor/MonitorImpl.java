...
import Monitor.MonitorImplAbstract;
 ...
 * @see Monitor.MonitorImplAbstract
 * @author COMODO
 * @version $Id$
 */
public class MonitorImpl extends MonitorImplAbstract {
	public void run() throws java.io.IOException,
		...
		while (isRunning()) {
			try {
				...
				getLogger().debug(" [MonitorImpl] Received '" + message + "'");

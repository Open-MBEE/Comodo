...
public class SMJavaInvoker implements Invoker {
	...
	private Logger mLogger = Logger.getLogger("Monitor");
	...
	public void invoke(String source, @SuppressWarnings("rawtypes") Map params)
		...
		if (mSource.contentEquals("SMActivityVerifyGoals.java")) {
			mJob = new SMActivityVerifyGoals("VerifyGoals", mParentStateId,
					mParentSCInstance, mLogger);
		}

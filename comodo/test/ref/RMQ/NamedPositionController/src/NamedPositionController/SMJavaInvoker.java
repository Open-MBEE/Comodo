...
public class SMJavaInvoker implements Invoker {
	...
	private Logger mLogger = Logger.getLogger("NamedPositionController");
	...
	public void invoke(String source, @SuppressWarnings("rawtypes") Map params)
		...
		if (mSource.contentEquals("SMActivityUpdateRefPos.java")) {
			mJob = new SMActivityUpdateRefPos("UpdateRefPos", mParentStateId,

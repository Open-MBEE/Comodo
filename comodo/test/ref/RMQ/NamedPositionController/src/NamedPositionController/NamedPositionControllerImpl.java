...
import NamedPositionController.NamedPositionControllerImplAbstract;
 ...
 * @see NamedPositionController.NamedPositionControllerImplAbstract
 * @author COMODO
 * @version $Id$
 */
public class NamedPositionControllerImpl
		extends
			NamedPositionControllerImplAbstract {
	public void run() throws java.io.IOException,
		...
		while (isRunning()) {
			try {
				...
				getLogger().debug(
						" [NamedPositionControllerImpl] Received '" + message
								+ "'");

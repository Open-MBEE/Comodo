...
import EncoderHealthEstimator.SMJavaInvoker;
 ...
 * @version $Id$
 */
public abstract class EncoderHealthEstimatorImplAbstract {
	private final static String CMD_QUEUE_NAME = "ENCODERHEALTHESTIMATORIMPL_CMD"; // for point to point commands
	...
	public boolean smLoadDefinition(final String fileName) {
		...
		if (fileName.isEmpty()) {
			modelLoc = "EncoderHealthEstimator.xml";
		}
		try {

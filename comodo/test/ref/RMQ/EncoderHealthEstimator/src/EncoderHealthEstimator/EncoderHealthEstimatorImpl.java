...
import EncoderHealthEstimator.EncoderHealthEstimatorImplAbstract;
 ...
 * @see EncoderHealthEstimator.EncoderHealthEstimatorImplAbstract
 * @author COMODO
 * @version $Id$
 */
public class EncoderHealthEstimatorImpl
		extends
			EncoderHealthEstimatorImplAbstract {
	public void run() throws java.io.IOException,
		...
		while (isRunning()) {
			try {
				...
				getLogger().debug(
						" [EncoderHealthEstimatorImpl] Received '" + message
								+ "'");

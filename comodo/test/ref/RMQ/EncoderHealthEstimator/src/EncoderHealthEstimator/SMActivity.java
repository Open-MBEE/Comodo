...
public abstract class SMActivity implements Runnable {
	...
	protected GetEncHealthFlag mGetEncHealthFlag = new GetEncHealthFlag(); // subscribing

	protected EncoderHealthSV mEncoderHealthSV = new EncoderHealthSV(); // publishing
	...
	public Message nextMessage(long timeout)
		...
		if (delivery != null) {
			...
			} else if (routingKey.matches("GetEncHealthFlag")) {
				mGetEncHealthFlag.setPayload(payload);
			}

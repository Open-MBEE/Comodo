...
import FilterWheelHWAdapter.SMJavaInvoker;
 ...
 * @version $Id$
 */
public abstract class FilterWheelHWApadpterImplAbstract {
	private final static String CMD_QUEUE_NAME = "FILTERWHEELHWAPADPTERIMPL_CMD"; // for point to point commands
	...
	public boolean smLoadDefinition(final String fileName) {
		...
		if (fileName.isEmpty()) {
			modelLoc = "FilterWheelHWAdapter.xml";
		}
		try {

...
import FilterWheelHWAdapter.GetEncHealthFlag;
import FilterWheelHWAdapter.GetMotorHealthFlag;
...
public abstract class SMActivity implements Runnable {
	...
	protected SetRefPos mSetRefPos = new SetRefPos(); // subscribing

	protected GetActPos mGetActPos = new GetActPos(); // publishing
	protected GetEncHealthFlag mGetEncHealthFlag = new GetEncHealthFlag(); // publishing
	protected GetMotorHealthFlag mGetMotorHealthFlag = new GetMotorHealthFlag(); // publishing
	...
	public Message nextMessage(long timeout)
		...
		if (delivery != null) {
			...
			} else if (routingKey.matches("SetRefPos")) {
				mSetRefPos.setPayload(payload);
			}

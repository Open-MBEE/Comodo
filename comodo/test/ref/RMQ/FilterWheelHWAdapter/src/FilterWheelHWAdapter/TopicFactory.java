...
public class TopicFactory {
	...
	public Topic createTopic(final String topicName, final String payload) {
		...
		if (topicName.isEmpty()) {
			/* error */
		} else if (topicName.matches("GetEncHealthFlag")) {
			t = new GetEncHealthFlag(payload);
		} else if (topicName.matches("GetActPos")) {
			t = new GetActPos(payload);
		} else if (topicName.matches("SetRefPos")) {
			t = new SetRefPos(payload);
		} else if (topicName.matches("GetMotorHealthFlag")) {
			t = new GetMotorHealthFlag(payload);
		} else {
			/* error */
		}
	...
	public HashMap<String, Topic> createAllTopics() {
		...
		t = new GetEncHealthFlag();
		map.put("GetEncHealthFlag", t);
		t = new GetActPos();
		map.put("GetActPos", t);
		t = new SetRefPos();
		map.put("SetRefPos", t);
		t = new GetMotorHealthFlag();
		map.put("GetMotorHealthFlag", t);

...
import FilterWheelHWAdapter.FilterWheelHWApadpterImplAbstract;
 ...
 * @see FilterWheelHWAdapter.FilterWheelHWApadpterImplAbstract
 * @author COMODO
 * @version $Id$
 */
public class FilterWheelHWApadpterImpl
		extends
			FilterWheelHWApadpterImplAbstract {
	public void run() throws java.io.IOException,
		...
		while (isRunning()) {
			try {
				...
				getLogger().debug(
						" [FilterWheelHWApadpterImpl] Received '" + message
								+ "'");

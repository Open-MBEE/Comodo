...
import Client.ClientImplAbstract;
 ...
 * @see Client.ClientImplAbstract
 * @author COMODO
 * @version $Id$
 */
public class ClientImpl extends ClientImplAbstract {
	public void run() throws java.io.IOException,
		...
		while (isRunning()) {
			try {
				...
				getLogger().debug(" [ClientImpl] Received '" + message + "'");

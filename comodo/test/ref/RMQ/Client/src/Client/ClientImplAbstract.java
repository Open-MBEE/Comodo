 ...
 * @version $Id$
 */
public abstract class ClientImplAbstract {
	private final static String CMD_QUEUE_NAME = "CLIENTIMPL_CMD"; // for point to point commands

...
import MotorHealthEstimator.SMJavaInvoker;
 ...
 * @version $Id$
 */
public abstract class MotorHealthEstimatorImplAbstract {
	private final static String CMD_QUEUE_NAME = "MOTORHEALTHESTIMATORIMPL_CMD"; // for point to point commands
	...
	public boolean smLoadDefinition(final String fileName) {
		...
		if (fileName.isEmpty()) {
			modelLoc = "MotorHealthEstimator.xml";
		}
		try {

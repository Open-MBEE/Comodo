...
public abstract class SMActivity implements Runnable {
	...
	protected GetMotorHealthFlag mGetMotorHealthFlag = new GetMotorHealthFlag(); // subscribing

	protected MotorHealthSV mMotorHealthSV = new MotorHealthSV(); // publishing
	...
	public Message nextMessage(long timeout)
		...
		if (delivery != null) {
			...
			} else if (routingKey.matches("GetMotorHealthFlag")) {
				mGetMotorHealthFlag.setPayload(payload);
			}

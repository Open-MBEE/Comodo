 ...
 * @version $Id$
 */
public abstract class wsf2ex1ImplAbstract {
	private final static String CMD_QUEUE_NAME = "WSF2EX1IMPL_CMD"; // for point to point commands
	...
	public wsf2ex1ImplAbstract() {

		mLogger = Logger.getLogger("wsf2ex1");

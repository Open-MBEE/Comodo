...
import Server.ServerImplAbstract;
 ...
 * @see Server.ServerImplAbstract
 * @author COMODO
 * @version $Id$
 */
public class ServerImpl extends ServerImplAbstract {
	public void run() throws java.io.IOException,
		...
		while (isRunning()) {
			try {
				...
				getLogger().debug(" [ServerImpl] Received '" + message + "'");

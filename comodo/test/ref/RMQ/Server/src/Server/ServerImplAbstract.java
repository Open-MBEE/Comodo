 ...
 * @version $Id$
 */
public abstract class ServerImplAbstract {
	private final static String CMD_QUEUE_NAME = "SERVERIMPL_CMD"; // for point to point commands
	...
	public ServerImplAbstract() {

		mLogger = Logger.getLogger("Server");

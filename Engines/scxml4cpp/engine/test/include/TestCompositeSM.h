...
/*
 * $Id: TestCompositeSM.h 1061 2015-07-13 15:03:59Z landolfa $
 */


#ifndef TestCompositeSM_H
#define TestCompositeSM_H
...
class TestCompositeSM : public CppUnit::TestFixture
{
	CPPUNIT_TEST_SUITE(TestCompositeSM);
